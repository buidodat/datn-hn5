    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                {{-- Quản lí chi nhánh --}}
                <li class="nav-item">
                    <a href="{{ route('admin.branches.index') }}" class="nav-link menu-link" data-key="t-horizontal"><i
                            class="ri-ancient-gate-fill"></i><span data-key="t-layouts">Quản lý chi nhánh</span></a>
                </li>

                {{-- Quản lí Rạp --}}
                <li class="nav-item">
                    <a href="{{ route('admin.cinemas.index') }}" class="nav-link menu-link" data-key="t-horizontal"> <i
                ...
                {{-- Vouchers --}}
                <li class="nav-item">
                    <a href="{{ route('admin.vouchers.index') }}" class="nav-link menu-link" data-key="t-horizontal"><i
                            class=" ri-coupon-3-line "></i> <span data-key="t-layouts">Vouchers</span></a>
                </li>

                {{-- Quản lí bài viết --}}
                <li class="nav-item">
                    <a href="{{ route('admin.posts.index') }}" class="nav-link menu-link" data-key="t-horizontal"><i
                ...
                {{-- Quản lí đồ ăn --}}
                <li class="nav-item">
                    <a href="{{ route('admin.food.index') }}" class="nav-link menu-link" data-key="t-horizontal"><i
                            class="ri-cake-3-fill"></i> <span data-key="t-layouts">Quản lý Đồ Ăn</span></a>
                </li>

                {{-- Quản lí Combo --}}
                <li class="nav-item">
                    <a href="{{ route('admin.combos.index') }}" class="nav-link menu-link" data-key="t-horizontal"> <i
                ...
                {{-- Quản lí Slideshows --}}
                <li class="nav-item">
                    <a href="{{ route('admin.slideshows.index') }}" class="nav-link menu-link" data-key="t-horizontal"> <i
                            class="ri-slideshow-3-line"></i> <span data-key="t-layouts">Slideshows</span></a>
                </li>

                {{-- Quản lí Liên hệ --}}
                <li class="nav-item">
                    <a href="{{ route('admin.contacts.index') }}" class="nav-link menu-link" data-key="t-horizontal"><i
                ...
                {{-- Tài khoản --}}
                <li class="nav-item">
                    <a href="{{ route('admin.users.index') }}" class="nav-link menu-link" data-key="t-horizontal"> <i
