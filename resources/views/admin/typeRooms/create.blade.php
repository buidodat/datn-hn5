...
@section('content')
    ...
    @endif --}}
    <form action="{{ route('admin.typeRooms.store') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Thông tin loại phòng</h4>
                    </div><!-- end card header -->
                    <div class="card-body">
                            ...
                            <div class="row gy-4">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label for="surcharge" class="form-label ">Phụ phí:</label>
                                            <input type="text" class="form-control" id="surcharge" name="surcharge"
                                                value="{{ old('surcharge') }}" placeholder="Nhập giá phụ phí">
                                            @error('surcharge')
                                                <div class='mt-1'>
                                                    <span class="text-danger">{{ $message }}</span>
                                                </div>
