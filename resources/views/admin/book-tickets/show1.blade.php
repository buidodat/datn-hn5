                                        ...
                                        <div class="col-md-12">
                                                        ...
                                                        <tbody>
                                                            @foreach ($combos as $combo)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $combo->name }} - {{ $combo->price_sale }} VNĐ
                                                                    </td>
                                                                    <td>
                                            ...
                                            <div class="total-price-checkout" id="getPriceOrder">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <p class="text-danger total-discount  px-2" id="totalPriceReduced">0
                                                        VNĐ</p>
                                                </div>
                                                <div class="d-flex justify-content-end">
                                                    <p>Số tiền cần thanh toán:</p>
                                                    <p class="text-danger total-price-payment  px-2" id="totalPricePaid">
                                                        105.000 VNĐ</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="box-payment-checkout">
                                                ...
                                                <div class="payment-checkout">
                                                    ...
                                                    <div class="img-payment-checkout">
                                                        <form action="" class="d-flex justify-content- ">
                                                            <div class=' mx-3'>
                                            ...
                                            <div class="giu-cho-checkout bg-light mt-5">
                                                <div class="row p-3 pb-0">
                                                    <div class="col-md-8">
                                                        <p>Vui lòng kiểm tra thông tin đầy đủ trước khi qua bước tiếp theo.
                                                            <br>
...
@section('script-libs')
    ...
    <script>
        ...
        function toggleSeat(element) {
            ...
            if (seatIndex > -1) {
                ...
                totalPrice -= seatPrice; // Giảm tổng giá
            ...
            document.getElementById('inputTotalPriceSeat').value = totalPrice;
    ...
    {{-- Xử lý voucher --}}
    <script>
        // function getPriceOrder(comboId = 0, quantity = 0) {
        //     $.ajax({
        //         url: '{{ route('get-price-order') }}',
        //         method: 'POST',
        //         headers: {
        //             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') // Thêm CSRF token vào headers
        //         },
        ...
        //             if (data.success) {
        //                 console.log(data);
        //                 $('#totalPrice').text(data.order.total_price.toLocaleString() + ' VNĐ');
        //                 $('#totalPriceReduced').text(data.order.total_price_reduced.toLocaleString() + ' VNĐ');
        //                 $('#totalPricePaid').text(data.order.total_price_paid.toLocaleString() + ' VNĐ');
        //             } else {
