            ...
            <div class="col-lg-9">
                <div class="card card-left">
                    ...
                    <div class="card-body mb-3">
                        ...
                        <input type="hidden" name="row_double" id="inputRowDouble" value="{{ $seatTemplate->row_double }}">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <div class="form-check form-radio-primary mb-3">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    data-row="{{ chr(65 + $row) }}" data-action="regular">
                                                            ...
                                                            <div class="form-check form-radio-primary mb-3">
                                                                <input class="form-check-input" type="radio"
                                                                    ...
                                                                    data-row="{{ chr(65 + $row) }}" data-action="double"
                                                                    @checked($isAllDouble)>
                        ...
                        @if ($seatTemplate->is_publish == 1)
                            <div class="card card-seat ">
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class='text-end'>
                                        <a href="{{ route('admin.seat-templates.index') }}" class='btn btn-light mx-1'>Quay
                                            lại</a>
                        ...
                        @else
                            <div class="card card-seat ">
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class='text-end'>
                                        <button type='submit' name='action'  value="draft" class='btn btn-light mx-1'>Lưu
                                            nháp</button>
                                        <button type="submit" name='action' value="publish" onclick="return confirm('Sau khi xuất bản không thể thay đổi vị trí ghế, bạn có chắc chắn ?')" class='btn btn-primary mx-1'>Xuất
                                            bản</button>
                                    </div>
