                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="branch_id" id="" class="form-select">
                                                ...
                                                @foreach ($branches as $id => $name)
                                                    <option value="{{ $id }}" @selected(old('branch_id') == $name )>{{ $name }}</option>
                                                @endforeach
                                            </select>
                                            @error('surcharge')
                                                <div class='mt-1'>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#branch').on('change', function() {
                ...
                cinemaSelect.empty();
                cinemaSelect.append('<option value="">Chọn mã rạp</option>');
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $.each(data, function(index, cinema) {
                                cinemaSelect.append('<option value="' + cinema.id + '">' + cinema.code + '</option>');
                            });
                        }
                    });
                }
