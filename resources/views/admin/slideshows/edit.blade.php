                        ...
                        <div class="row gy-4">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control fs-4 fw-semibold" id="title" name="title" value="{{ $post->title }}" >
                                    @error("title")
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control fs-5 fw-semibold"  rows="3" name="description" >{{ $post->description }}</textarea>
                                    @error("description")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" cols="50" rows="50" name="content" value="{{ $post->content }}">{{ $post->content }}</textarea>
                                    @error("content")
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="form-check form-switch form-switch-default">
                                            <input class="form-check-input" type="checkbox" role=""
                                                name="is_active" @checked($post->is_active == 1 )>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        ...
                                        <div class="form-check form-switch form-switch-success">
                                            <input class="form-check-input" type="checkbox" role=""
                                                name="is_popular" @checked($post->is_popular == 1 ) >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label class="form-check-label" for="is_hot_post">Is Hot</label>
                                        <div class="form-check form-switch form-switch-danger">
                                            <input class="form-check-input" type="checkbox" role=""
                                                name="is_hot_post"  @checked($post->is_hot_post == 1 ) >
                                        </div>
                                    </div>
                                </div>
                            </div>
