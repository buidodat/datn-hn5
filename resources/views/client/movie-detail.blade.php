                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="st_md_ts_main_sec float_left">
                                            <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/md1.png" alt="img">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="st_md_ts_main_sec float_left">
                                            <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/md2.png" alt="img">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="st_md_ts_main_sec float_left">
                                            <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/md3.png" alt="img">
                                                    ...
                                                    <div class="owl-carousel owl-theme">
                                                        <div class="item">
                                                            <div class="st_summ_slider_cont float_left">
                                                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/c1.jpg" alt="img">
                                                        ...
                                                        <div class="item">
                                                            <div class="st_summ_slider_cont float_left">
                                                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/c2.jpg" alt="img">
                                                        ...
                                                        <div class="item">
                                                            <div class="st_summ_slider_cont float_left">
                                                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/c3.jpg" alt="img">
                                                        ...
                                                        <div class="item">
                                                            <div class="st_summ_slider_cont float_left">
                                                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/c4.jpg" alt="img">
                                            ...
                                            <div class="col-md-12">
                                                <div class="st_md_summ_client_slider float_left">
                                                    ...
                                                    <div class="owl-carousel owl-theme">
                                                        <div class="item">
                                                            <div class="st_summ_slider_cont float_left">
                                                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/c5.jpg" alt="img">
                                                        ...
                                                        <div class="item">
                                                            <div class="st_summ_slider_cont float_left">
                                                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/c6.jpg" alt="img">
                                                        ...
                                                        <div class="item">
                                                            <div class="st_summ_slider_cont float_left">
                                                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/c7.jpg" alt="img">
                                                        ...
                                                        <div class="item">
                                                            <div class="st_summ_slider_cont float_left">
                                                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/c8.jpg" alt="img">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
                                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/movie_single/sc1.jpg" alt="scene_img">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
                                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/movie_single/sc2.jpg" alt="scene_img">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
                                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/movie_single/sc3.jpg" alt="scene_img">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
                                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/movie_single/sc4.jpg" alt="scene_img">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
                                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/movie_single/sc5.jpg" alt="scene_img">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
                                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/movie_single/sc6.jpg" alt="scene_img">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="st_ind_sidebar_advertiz st_ind_sidebar_advertiz_md float_left">
                                    <a href="#">
                                        <img src="{{ env('APP_URL') . '/theme/client/' }}images/index_III/add.png" alt="img">
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-12">
            ...
            <ul class="album-slider">
                    ...
                    <figure class="album">
                        <div class="prs_upcom_movie_box_wrapper">
                            <div class="prs_upcom_movie_img_box">
                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/up1.jpg" alt="movie_img" />
                ...
                <li class="album-slider__item">
                    <figure class="album">
                        <div class="prs_upcom_movie_box_wrapper">
                            <div class="prs_upcom_movie_img_box">
                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/up2.jpg" alt="movie_img" />
                                <div class="prs_upcom_movie_img_overlay"></div>
                                <div class="prs_upcom_movie_img_btn_wrapper">
                                    <ul>
                                        <li><a href="#">View Trailer</a>
                ...
                <li class="album-slider__item">
                    <figure class="album">
                        <div class="prs_upcom_movie_box_wrapper">
                            <div class="prs_upcom_movie_img_box">
                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/up3.jpg" alt="movie_img" />
                                <div class="prs_upcom_movie_img_overlay"></div>
                                <div class="prs_upcom_movie_img_btn_wrapper">
                                    <ul>
                                        <li><a href="#">View Trailer</a>
                ...
                <li class="album-slider__item">
                    <figure class="album">
                        <div class="prs_upcom_movie_box_wrapper">
                            <div class="prs_upcom_movie_img_box">
                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/up4.jpg" alt="movie_img" />
                                <div class="prs_upcom_movie_img_overlay"></div>
                                <div class="prs_upcom_movie_img_btn_wrapper">
                                    <ul>
                                        <li><a href="#">View Trailer</a>
                ...
                <li class="album-slider__item">
                    <figure class="album">
                        <div class="prs_upcom_movie_box_wrapper">
                            <div class="prs_upcom_movie_img_box">
                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/up5.jpg" alt="movie_img" />
                                <div class="prs_upcom_movie_img_overlay"></div>
                                <div class="prs_upcom_movie_img_btn_wrapper">
                                    <ul>
                                        <li><a href="#">View Trailer</a>
                ...
                <li class="album-slider__item">
                    <figure class="album">
                        <div class="prs_upcom_movie_box_wrapper">
                            <div class="prs_upcom_movie_img_box">
                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/up6.jpg" alt="movie_img" />
                                <div class="prs_upcom_movie_img_overlay"></div>
                                <div class="prs_upcom_movie_img_btn_wrapper">
                                    <ul>
                                        <li><a href="#">View Trailer</a>
                ...
                <li class="album-slider__item">
                    <figure class="album">
                        <div class="prs_upcom_movie_box_wrapper">
                            <div class="prs_upcom_movie_img_box">
                                <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/up7.jpg" alt="movie_img" />
                                <div class="prs_upcom_movie_img_overlay"></div>
                                <div class="prs_upcom_movie_img_btn_wrapper">
                                    <ul>
                                        <li><a href="#">View Trailer</a>
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="prs_pn_img_wrapper">
                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/p1.jpg" alt="patner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="prs_pn_img_wrapper">
                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/p2.jpg" alt="patner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="prs_pn_img_wrapper">
                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/p3.jpg" alt="patner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="prs_pn_img_wrapper">
                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/p4.jpg" alt="patner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="prs_pn_img_wrapper">
                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/p5.jpg" alt="patner_img">
                                </div>
                            </div>
                            <div class="item">
                                <div class="prs_pn_img_wrapper">
                                    <img src="{{ env('APP_URL') . '/theme/client/' }}images/content/p6.jpg" alt="patner_img">
                                </div>
                            </div>
                        </div>
                    </div>
